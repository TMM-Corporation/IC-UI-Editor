var moving1 = {
	...
	toScaling = {
		scaleUp: {
			image: "button_scale_up", click: function (v) {
		...
		scaleDown: {
			image: "button_scale_down", click: function (v) {
				Widgets.run(function () {
	...
	menu = {
		adding: {
			image: "button_add", click: function (v) {
				Widgets.run(function () {
		...
		moving: {
			image: "button_moving", click: function (v) {
				Widgets.run(function () {
					var v1 = [];
		...
		removing: {
			image: "button_remove", click: function (v) {
				Widgets.run(function () {
		...
		scaling: {
			image: "button_scaling", click: function (v) {
				Widgets.run(function () {
		...
		close: {
			image: "button_close", click: function (v) {
				Widgets.run(function () {
					...
					WindowManager.menu("mainMenu", "main", addWidgetsFrom(start));
				});
			}
		},
		change: {
			image: "button_change2", click: function (v) {
				Widgets.run(function () {
		...
		selectElement: {
			image: "button_list", click: function (v) {
				Widgets.run(function () {
					selectElement();
				});
			}
		...
		info: {
			image: "button_info", click: function (v) {
				Widgets.run(function () {
					if (editorUI.current) {
						alert(editorUI.name + "\n")
